...
// ../../packages/ui/components/src/tamagui.config.ts
...
var getThemeInfo = /* @__PURE__ */ __name((theme2, name) => THEME_INFO.get(name || JSON.stringify(theme2)), "getThemeInfo");
var setThemeInfo = /* @__PURE__ */ __name((theme2, info) => {
  const next = {
    ...info,
    cache: /* @__PURE__ */ new Map()
  };
  THEME_INFO.set(info.name || JSON.stringify(theme2), next), THEME_INFO.set(JSON.stringify(info.definition), next);
}, "setThemeInfo");
...
function createTheme(palette, definition, options, name, skipCache = false) {
  ...
  return setThemeInfo(theme2, {
    palette,
    definition,
    options,
    name
  }), cacheKey && identityCache.set(cacheKey, theme2), theme2;
}
...
function applyMask(theme2, mask, options = {}, parentName, nextName) {
  const info = getThemeInfo(theme2, parentName);
...
function applyMaskStateless(info, mask, options = {}, parentName) {
  ...
  const maskOptions = {
    ...
    ...options,
    skip
  }, template = mask.mask(info.definition, maskOptions), theme2 = createTheme(info.palette, template);
  return {
    ...info,
    cache: /* @__PURE__ */ new Map(),
    definition: template,
...
var combineMasks = /* @__PURE__ */ __name((...masks2) => ({
  name: "combine-mask",
  mask: /* @__PURE__ */ __name((template, opts) => {
    let current = getThemeInfo(template, opts.parentName), theme2;
    for (const mask2 of masks2) {
      ...
      current = next, theme2 = next.theme;
    }
    return theme2;
  }, "mask")
}), "combineMasks");
...
var selectionStyles = /* @__PURE__ */ __name((theme2) => theme2.color5 ? {
  backgroundColor: theme2.color5,
  color: theme2.color11
...
var tokens2 = (0, import_core3.createTokens)({
  ...theme,
  size: size3,
